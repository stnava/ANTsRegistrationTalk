...
2.  Follow by an *affine transformation*:  $I \approx J(A(R(x)))$ s.t. negative $MI(I,J,A \circ R)$ is minimized

3.  Finally, a *diffeomorphism*:  $I \approx J(\phi(A(R(x))))$ s.t. $k$-neighborhood correlation $CC_k(I,J,A \circ R)$ is minimized
