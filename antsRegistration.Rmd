...
# <span style="color:red;">Medical Image Registration</span> <br /> Fundamental tool for morphometry, segmentation,<br /> motion estimation and <br /> <span style="color:blue;">data cleaning</span>
...
* important for new schemes that *voting* for combining **anatomical or transformation** dictionaries
