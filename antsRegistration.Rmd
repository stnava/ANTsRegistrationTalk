...
* Freesurfer is the historial standard for measuring cortical thickness

* instead of using surfaces, we use the image space *DiReCTly*
...
* and [this paper](http://www.ncbi.nlm.nih.gov/pubmed/24879923)
...
## ANTs*R* $\rightarrow$ new insight <br />via a better analytics
