...
* Several "wins" in public knock-abouts ( [Klein 2009](http://www.ncbi.nlm.nih.gov/pubmed/19195496), [Murphy 2011](http://www.ncbi.nlm.nih.gov/pubmed/21632295), [SATA 2012 and 2013](http://www.ncbi.nlm.nih.gov/pmc/articles/PMC3837555/), [BRATS 2013](http://martinos.org/qtim/miccai2013/proc_brats_2013.pdf) ) 
...
# <span style="color:red;">Medical Image Registration</span> <br /> Fundamental tool for morphometry, segmentation, motion estimation and <br /> <span style="color:blue;">data cleaning</span>
...
$$ M(I,J,\phi(x,p)) $$ is minimized

Must select both metric $M$ and transformation $\mathcal{T}$

... in addition to optimizer and the problem's resolution


## Concatenating transformation / metric stages are necessary in real data
